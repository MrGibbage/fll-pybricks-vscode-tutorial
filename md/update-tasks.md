...
"tasks": [
        {
            ...
            "type": "shell",
            "command": "${workspaceFolder}/.venv/bin/pybricksdev",
            "windows": {
...
[Next: How to update snippets](https://github.com/MrGibbage/fll-pybricks-vscode-tutorial/blob/main/md/update-snippets.md)
