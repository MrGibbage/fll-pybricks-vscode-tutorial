...
- Make sure you follow the steps correctly to connect the robot to the laptop. You must be holding the bluetooth button down while you are pluging it in to the laptop
- Finially, you will almost certainly have to install the drivers each time you connect a different robot to your computer
- Do not use any special characters in your robot name. Just letters, no spaces
