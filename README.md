...
* Laptop(s). I use Windows, however this has been confirmed to work on Unix and Mac OS (thank you [@amcnabb](https://github.com/amcnabb). It absolutely will not work on Chromebooks (bluetooth issues). You will need admin access to the laptop because you will be installing software on it.
